...
import alma.control.gui.antennamount.chessboard.plugins.DartboardPluginHolder;
import alma.control.gui.antennamount.chessboard.plugins.MountControlPluginHolder;
import alma.exec.extension.subsystemplugin.PluginContainerServices;

public class MountControlDetailsProvider implements ChessboardDetailsPluginFactory {
    ...
    public ChessboardDetailsPlugin[] instantiateDetailsPlugin(
        ...
        plugin[0] = new MountControlPluginHolder(
	        names,
		listener,
		containerServices,
		pluginTitle,

...
public class DartboardDetailsProvider implements ChessboardDetailsPluginFactory {
    ...
    public ChessboardDetailsPlugin[] instantiateDetailsPlugin(
        ...
        containerServices.getLogger().log(AcsLogLevel.DEBUG,"instantiateDetailsPlugin "+names[0]);
	ChessboardDetailsPlugin[] plugin = new ChessboardDetailsPlugin[INSTANCES];
        plugin[0] = new DartboardPluginHolder(
                names,
		listener,
		containerServices,
		pluginTitle,

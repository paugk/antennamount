...
public class Metrology extends MetrologyCommon implements IMetrology {
	 ...
	 * The mount
	 */
	private final alma.Control.MountVertexLLama mount;
	 ...
	 */
	public Metrology(alma.Control.MountVertexLLama mount, Logger logger, MountListenersNotifier notifier) {
		super(mount, AntennaType.VERTEX, logger, notifier);
		this.mount=mount;
		this.logger=logger;
	}

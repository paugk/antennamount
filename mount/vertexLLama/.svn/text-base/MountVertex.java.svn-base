 ...
 *
 */
public final class MountVertex extends Mount {
	
	// ACU error descriptions stuffs
	// To be replaced when the code generator will be used
	private static final String[] acuStates = {
/*		alma.Control.MountVertexPrototype.ACU_ERROR_DESC_00,
		alma.Control.MountVertexPrototype.ACU_ERROR_DESC_01,
		alma.Control.MountVertexPrototype.ACU_ERROR_DESC_02,
		alma.Control.MountVertexPrototype.ACU_ERROR_DESC_03,
		alma.Control.MountVertexPrototype.ACU_ERROR_DESC_04,
		alma.Control.MountVertexPrototype.ACU_ERROR_DESC_05,
		alma.Control.MountVertexPrototype.ACU_ERROR_DESC_06,
		alma.Control.MountVertexPrototype.ACU_ERROR_DESC_07,
		alma.Control.MountVertexPrototype.ACU_ERROR_DESC_08,
		alma.Control.MountVertexPrototype.ACU_ERROR_DESC_09,
		alma.Control.MountVertexPrototype.ACU_ERROR_DESC_0A */
	};
	 ...
	 */
	private final alma.Control.MountVertex vertex;
	 ...
	 */
	public MountVertex(
			alma.Control.MountVertex mnt, 
			ACSComponentsManager.AntennaType type, 
			ContainerServices contSvcs,
			AntennaRootPane rootP) {
		super(mnt,type,contSvcs,rootP);
		if (type!=ACSComponentsManager.AntennaType.VERTEX) {
			throw new IllegalStateException("The component is a Vertex but the passed type is "+type);
		}

...
public class Metrology extends MetrologyCommon implements IMetrology {
	 ...
	 * The mount
	 */
	private final alma.Control.MountA7M mount;
	 ...
	 */
	public Metrology(alma.Control.MountA7M mount, Logger logger, MountListenersNotifier notifier) {
		super(mount, AntennaType.MELCOA7M, logger, notifier);
		this.mount=mount;
		this.logger=logger;
	}

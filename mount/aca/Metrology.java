...
public class Metrology extends MetrologyCommon implements IMetrology {
	 ...
	 * The mount
	 */
	private final alma.Control.MountACA mount;
	 ...
	 */
	public Metrology(alma.Control.MountACA mount, Logger logger, MountListenersNotifier notifier) {
		super(mount, AntennaType.MELCO, logger, notifier);
		this.mount=mount;
		this.logger=logger;
	}

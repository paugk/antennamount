...
import alma.Control.MountVertexBase;
import alma.Control.MountVertexBaseOperations;
import alma.Control.MountVertexOperations;
...
public class VertexSubreflector extends SubreflectorCommon implements ISubreflector {
	...
	private alma.Control.MountVertex vertex;
	 ...
	 */
	public VertexSubreflector(alma.Control.MountVertex mount, AntennaRootPane rootP, Logger log) {

 ...
 * @since ALMA 7.1.1
 */
public class Melco12mModel extends CommonMetrologyModel {
	...
	enum EquipStatus {
		...
		LINEAR_SCALE4("Linear scale 4 alarm",1,3),
		LINEAR_SCALE5("Linear scale 5 alarm",1,4),
		...
		LINEAR_SCALE14("Linear scale 14 alarm",2,5),
		LINEAR_SCALE15("Linear scale 15 alarm",2,6),
		LINEAR_SCALE16("Linear scale 16 alarm",2,7),
		
		METROLOGY_RELIABLE("Metrology reliable",3,7);
	 ...
	 */
	public Melco12mModel(AntennaRootPane antennaRootPane, IMetrology metrology) {

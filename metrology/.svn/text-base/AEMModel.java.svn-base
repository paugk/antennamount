 ...
 * @since ALMA 7.1.1
 */
public class AEMModel extends CommonMetrologyModel {
	
	enum EquipStatus {
		POWER_OFF("Power OFF",0,0),
		TILTMETER_POWER_OFF("Tiltmeter power OFF",0,1),
		THERMAL_COMM("Thermal metrology communication",0,2),
		RTILT_COMM("Right tiltmeter communication",0,3),
		LTILT_COMM("Left tiltmeter communication",0,4),
		THERMAL_OUTRANGE("Thermal metrology out of range",0,5),
		RTILTL_OUTRANGE("Right tiltmeter out of range",0,6),
		LTILTL_OUTRANGE("Left tiltmeter out of range",0,6);
	 ...
	 */
	public AEMModel(AntennaRootPane antennaRootPane, IMetrology metrology) {
